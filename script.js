...
const Sungeometry = new THREE.SphereBufferGeometry(1.2, 32, 32)
...
const Marsgeometry = new THREE.SphereBufferGeometry(0.22, 32, 32)
const Jupitergeometry = new THREE.SphereBufferGeometry(0.60, 32, 32)
const Saturngeometry = new THREE.SphereBufferGeometry(0.5, 32, 32)
const SaturnRinggeometry = new THREE.RingBufferGeometry(0.6,0.75,30)
