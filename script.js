...
const Sungeometry = new THREE.SphereBufferGeometry(5, 32, 32)
const Mercurygeometry = new THREE.SphereBufferGeometry(1.25,32,32)
const Venusgeometry = new THREE.SphereBufferGeometry(1.8,32,32)
const Earthgeometry = new THREE.SphereBufferGeometry(2, 32, 32)
const Marsgeometry = new THREE.SphereBufferGeometry(1, 32, 32)
const Jupitergeometry = new THREE.SphereBufferGeometry(3, 32, 32)
const Saturngeometry = new THREE.SphereBufferGeometry(2.5, 32, 32)
const SaturnRinggeometry = new THREE.RingBufferGeometry(3,0.70,30)
const Uranusgeometry = new THREE.SphereBufferGeometry(1.8, 32, 32)
const Neptunegeometry = new THREE.SphereBufferGeometry(1.5, 32, 32)
